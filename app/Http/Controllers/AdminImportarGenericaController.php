...
class AdminImportarGenericaController extends Controller
{
    /**
    ...
    {
       return view('vistas_ramiro.ventanaAgregarGenerica');
    }
            ...
            case 'text/plain':            
             \Storage::disk('local')->put('/public/csv/'.$nombre.".csv", \File::get($file));
                  ...
                  //$csv_file_path = storage_path($ruta).$nombre.'.csv';
                   ...
                   fclose($handle);
                   Session::flash('message', "Archivo csv con datos genericos insertado correctamente: ".''.$dato);
